            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="0" id="search">
                <tr>
                    ...
                    <td width="10%" align="center" valign="middle" style="text-align:right; width:150px;"><a
                            href="manager_add.jsp" target="mainFrame" onFocus="this.blur()" class="add">新增成员</a></td>
                </tr>
            </table>
        </td>
    </tr>
        ...
        <td align="left" valign="top">
            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="0" id="main-tab">
                ...
                <c:forEach items="${members }" var="member" varStatus="status">
                    <tr class="bggray" onMouseOut="this.style.backgroundColor='#f9f9f9'"
                        ...
                        <td align="center" valign="middle"
                            class="borderright borderbottom">${member.memberInstitute}</td>
                        ...
                        <td align="center" valign="middle" class="borderbottom"><a
                                href="${pageContext.request.contextPath}/MemberInfo?mname=${member.loginName }"
                                target="mainFrame" onFocus="this.blur()" class="add">编辑</a><span class="gray">&nbsp;|&nbsp;</span><a
                                href="Update?ope=dele" target="mainFrame" onFocus="this.blur()" class="add"
