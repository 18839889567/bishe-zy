...
<head>
    ...
    <script type="text/javascript" src="${pageContext.request.contextPath}/view/admin/js/sdmenu.js"></script>
...
<div id="left-top">
    <div><img src="${pageContext.request.contextPath}/view/header/${member.memberHeader}" width="44" height="44"/></div>
    <span>用户：${member.loginName }<br>角色：<c:choose><c:when
            test="${member.managerId}==1">普通管理员</c:when><c:otherwise>超级管理员</c:otherwise></c:choose></span>
</div>
