            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="0" id="search">
                <tr>
                    ...
                    <td width="10%" align="center" valign="middle" style="text-align:right; width:150px;"><a
                            href="community_add.jsp" target="mainFrame" onFocus="this.blur()" class="add">添加社团</a></td>
                </tr>
            </table>
        </td>
    </tr>
                ...
                <c:forEach items="${Community }" var="com" varStatus="status">
                    <tr onMouseOut="this.style.backgroundColor='#ffffff'"
                        ...
                        <td align="center" valign="middle"
                            class="borderright borderbottom">${com.communityCreaterName}</td>
                        <td align="center" valign="middle"
                            class="borderright borderbottom">${com.communityCreateDate}</td>
                        ...
                        <td align="center" valign="middle"
                            class="borderright borderbottom">${com.communityClassName }</td>
                        <td align="center" valign="middle" class="borderright borderbottom">${com.communityCreate }</td>
                        <td align="center" valign="middle" class="borderbottom"><a href="add.jsp" target="mainFrame"
                                                                                   onFocus="this.blur()"
                                                                                   class="add">编辑</a><span class="gray">&nbsp;|&nbsp;</span><a
                                href="add.jsp" target="mainFrame" onFocus="this.blur()" class="add">删除</a></td>
                    </tr>
                </c:forEach>
