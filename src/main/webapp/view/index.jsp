...
<head>
    <base href="<%=basePath%>">
    <title>社团生活</title>
    <link rel="icon" href="${pageContext.request.contextPath}/view/images/pande.png">
    ...
    <link href="${pageContext.request.contextPath}/view/css/bootstrap.min.css" rel="stylesheet" type="text/css"
          media="all"/>
    <link href="${pageContext.request.contextPath}/view/css/chromagallery.css" rel="stylesheet" type="text/css"
          media="all"/>
    <link href="${pageContext.request.contextPath}/view/css/style.css" rel="stylesheet" type="text/css" media="all"/>
    <style type="text/css">
        #container {
            width: 80%;
            margin: 30px auto;
    ...
    <!-- /fonts -->
    <!-- js files -->
    <script src="${pageContext.request.contextPath}/view/js/modernizr.custom.js"></script>
    <script src="${pageContext.request.contextPath}/view/js/jquery.min.js"></script>
    <script src="${pageContext.request.contextPath}/view/js/speech/jQuery.speech.js"></script>
    <script src="${pageContext.request.contextPath}/view/js/speech/jQuery.speech.min.js"></script>
    <script src="${pageContext.request.contextPath}/view/js/backtotop.js"></script>
    <script src="${pageContext.request.contextPath}/view/js/bootstrap.min.js"></script>
    <script src="${pageContext.request.contextPath}/view/js/SmoothScroll.min.js"></script>
    <!-- /js files -->
</head>
            ...
            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                <ul class="social-icons1">
                    ...
                    <c:if test="${login == null}">
                        <li class="y-in"><a href="${pageContext.request.contextPath}/view/login.jsp"
                                            style="{color:#fffff;}">登陆</a></li>
...
<div id="myCarousel" class="carousel slide" data-ride="carousel">
    ...
    <div class="carousel-inner" role="listbox">
        <div class="item active">
            <img class="first-slide" src="${pageContext.request.contextPath}/view/images/banner4.jpg" alt="First slide">
            <div class="container">
        ...
        <div class="item">
            <img class="second-slide" src="${pageContext.request.contextPath}/view/images/banner02.jpg"
                 alt="Second slide">
            <div class="container">
                <div class="carousel-caption">
        ...
        <div class="item">
            <img class="third-slide" src="${pageContext.request.contextPath}/view/images/banner03.jpg"
                 alt="Third slide">
            <div class="container">
                <div class="carousel-caption">
        ...
        <div class="row">
                ...
                <div class="serv-details">
                    <div class="row">
                        <div class="col-sm-6 col-xs-6">
                            <img src="${pageContext.request.contextPath}/view/images/serv- chemistry.jpg" alt=""
            ...
            <div class="col-lg-6 col-md-6">
                <div class="serv-details">
                    <div class="row">
                        <div class="col-sm-6 col-xs-6">
                            <img src="${pageContext.request.contextPath}/view/images/serv-geographical.jpg" alt=""
                                 class="img-responsive slideanim">
                        </div>
                        <div class="col-sm-6 col-xs-6">
                            <div class="serv-img-details slideanim">
        ...
        <div class="row">
            <div class="col-lg-6 col-md-6">
                <div class="serv-details">
                    <div class="row">
                        <div class="col-sm-6 col-xs-6">
                            <img src="${pageContext.request.contextPath}/view/images/serv-math.jpg" alt=""
                                 class="img-responsive slideanim">
                        </div>
                        <div class="col-sm-6 col-xs-6">
            ...
            <div class="col-lg-6 col-md-6">
                <div class="serv-details">
                    <div class="row">
                        <div class="col-sm-6 col-xs-6">
                            <img src="${pageContext.request.contextPath}/view/images/serv-img4.jpg" alt=""
                                 class="img-responsive slideanim">
                        </div>
                        <div class="col-sm-6 col-xs-6">
                            <div class="serv-img-details slideanim">
                                <h4><a href="${pageContext.request.contextPath}/view/info/community_info.jsp"
                                       target="_blank">计算机协会</a></h4>
                                <p>计算机协会</p>
                            </div>
                        </div>
                    </div>
        ...
        <div class="row">
            <div class="col-lg-6 col-md-6">
                <div class="serv-details">
                    <div class="row">
                        <div class="col-sm-6 col-xs-6">
                            <img src="${pageContext.request.contextPath}/view/images/serv-img1.jpg" alt=""
                                 class="img-responsive slideanim">
                        </div>
                        <div class="col-sm-6 col-xs-6">
                            <div class="serv-img-details slideanim">
                                <h4><a href="${pageContext.request.contextPath}/view/info/community_info.jsp"
                                       target="_blank">English.net 协会</a></h4>
                                <p>English.net 协会</p>
                            </div>
                        </div>
                    </div>
            ...
            <div class="col-lg-6 col-md-6">
                <div class="serv-details">
                    <div class="row">
                        <div class="col-sm-6 col-xs-6">
                            <img src="${pageContext.request.contextPath}/view/images/serv-img2.jpg" alt=""
                                 class="img-responsive slideanim">
                        </div>
                        <div class="col-sm-6 col-xs-6">
                            <div class="serv-img-details slideanim">
        ...
        <div class="row">
            <div class="col-lg-6 col-md-6">
                <div class="serv-details">
                    <div class="row">
                        <div class="col-sm-6 col-xs-6">
                            <img src="${pageContext.request.contextPath}/view/images/serv-img3.jpg" alt=""
                                 class="img-responsive slideanim">
                        </div>
                        <div class="col-sm-6 col-xs-6">
                            <div class="serv-img-details slideanim">
                                <h4><a href="${pageContext.request.contextPath}/view/info/community_info.jsp"
                                       target="_blank">心里学社</a></h4>
                                <p>心里学社</p>
                            </div>
                        </div>
                    </div>
...
<section class="our-services" id="notice">
    ...
    <div id="container">
        <ul class="noticeList">
            <li><a href="${pageContext.request.contextPath}/view/info/activityDetil.jsp" title="" target="_Blank">创业协会2016.5.25创客空间活动室
                :针对“大众创新万众创业”活动开展相应培训</a></li>
            <li><a href="${pageContext.request.contextPath}/view/info/activityDetil.jsp" title="" target="_blank">计算机协会2016.11.6计算机科研室
                :举办大学生“Oracl"甲骨文ACM竞赛</a></li>
            <li><a href="${pageContext.request.contextPath}/view/info/activityDetil.jsp" title="" target="_blank">天文地理协会
                2016.10.9教学楼103 :"走进天文，探索奥秘"主题活动，讲解天体观测</a></li>
            <li><a href="${pageContext.request.contextPath}/view/info/activityDetil.jsp" title="" target="_blank">数学应用协会
                2016.5.6 教学楼505 :数学课堂知识模拟大赛</a></li>
            <li><a href="${pageContext.request.contextPath}/view/info/activityDetil.jsp" title="" target="_blank">English.net协会
                2016.3.20 成栋教阶三 :“新生杯”英语演讲比赛海选赛</a></li>
            <li><a href="${pageContext.request.contextPath}/view/info/activityDetil.jsp" title="" target="_blank">English.net协会
                2016.3.25 成栋教阶三 :“新生杯”英语演讲比赛决赛、颁奖仪式</a></li>
            <li><a href="${pageContext.request.contextPath}/view/info/activityDetil.jsp" title="" target="_blank">心理健康协会
                2016.11.11 研楼436 :“阳光之旅”系列心理健康教育活动宣讲会</a></li>
            <li><a href="${pageContext.request.contextPath}/view/info/activityDetil.jsp" title="" target="_blank">阳光公益社
                2016.4.28 幸福中心小学 :深入课堂，走进学生身边开展支教活动 </a></li>
            <li><a href="${pageContext.request.contextPath}/view/info/activityDetil.jsp" title="" target="_blank">健身协会
                2016.5.6 体育馆健身馆 :普及健康知识，进行健身动作讲解</a></li>
            <li><a href="${pageContext.request.contextPath}/view/info/activityDetil.jsp" title="" target="_blank">魔术协会
                2016.5.20 大学生活动中心 :魔术巅峰展演</a></li>
            <li><a href="${pageContext.request.contextPath}/view/info/activityDetil.jsp" title="" target="_blank">排球协会
                2016.6.6 北区体育场 :校园排球友谊赛开幕式</a></li>
        </ul>
    </div>
...
<script src="${pageContext.request.contextPath}/view/js/chromagallery.pkgd.min.js"></script>
...
<script>
    ...
    $('.speech>p').speech({
        ...
        "sHeight": 16, //链接按钮的高度
        "https": true, //启用https
        "bg": "${pageContext.request.contextPath}/view//images/speech.jpg", //链接按钮的背景图片
    });
</script>
<!-- /js files -->
<!-- 弹出未登录alert -->
