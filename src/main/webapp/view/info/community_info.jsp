                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-10 col-xs-12">
                            <div class="about-info slideanim">
                                <h5>赵德柱</h5>
                                <p>
                                    会长：学生社团会长是学生社团的执行机构，是学生社团的最高行政管理机构。有新生会员队长的任免权；具有管理协会的一切活动的权力；对副会长以及各部长具有监督义务同时也具有对部长的任免权；会长及各职能机构各司其职，共同为学校学生社团的发展贡献力量。</p>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-10 col-xs-12">
                            <div class="about-info slideanim">
                                <h5>张小美</h5>
                                <p>
                                    组织文化部长：负责社团内部的组织、人事的管理工作；负责社团文化建设，通过建立社团品牌文化以树立社团形象；负责监督并协助会长做好各项规章制度的修订与更新工作；负责社团会员的考核评选：学期性：优秀团队、优秀队长、优秀会员；学年性：社团积极份子、年度优秀团队、年度优秀队长、年度优秀会员的评选。</p>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-10 col-xs-12">
                            <div class="about-info slideanim">
                                <h5>王大锤</h5>
                                <p>
                                    网络宣传部长：负责社团的海报、横幅、喷绘、写真、展板、广播等宣传工作；具有接受社团联培训与联系社团联一起做好宣传的义务；负责社团文化以及社团活动的宣传；负责社团工作简报和活动简报的撰写工作和社团活动的新闻采访工作。社团工作和活动视频制作、技术支持等。</p>
                            </div>
                        </div>
                    </div>
                </div>
