...
<!DOCTYPE html PUBLIC "-//W3C//DTD HTML 4.01 Transitional//EN" "http://www.w3.org/TR/html4/loose.dtd">
    ...
    <style>
        ...
        #addinfo a {
            font-size: 14px;
            font-weight: bold;
            background: url(${pageContext.request.contextPath}/admin/images/main/addinfoblack.jpg) no-repeat 0 1px;
            padding: 0px 0 0px 20px;
            line-height: 45px;
        }

        #addinfo a:hover {
            background: url(${pageContext.request.contextPath}/admin/images/main/addinfoblue.jpg) no-repeat 0 1px;
        }
    </style>
...
<table width="99%" border="0" cellspacing="0" cellpadding="0" id="searchmain">
    ...
    <tr>
        <td align="left" valign="top" id="addinfo">
            ...
            <c:if test="${param.rs =='success' }"><font -size="4px" ;
                                                        color=blue>&nbsp;&nbsp;&nbsp;<b>添加成功</b></font></c:if>
            <c:if test="${param.rs =='fail' }"><font -size="4px" ;
                                                     color=red>&nbsp;&nbsp;&nbsp;<b>添加失败，请重新尝试</b></font></c:if>
            <c:if test="${param.rs =='exist' }"><font -size="4px" ;
                                                      color=red>&nbsp;&nbsp;&nbsp;<b>社团名已存在</b></font></c:if>
            <c:if test="${param.rs =='mNotIn' }"><font -size="4px" ;
                                                       color=red>&nbsp;&nbsp;&nbsp;<b>请填写正确创建人姓名或完善该用户信息</b></font></c:if>
        </td>
    </tr>
    <tr>
            ...
            <form method="post" action="${pageContext.request.contextPath}/Regist?ope=community">
                <table width="100%" border="0" cellspacing="0" cellpadding="0" id="main-tab">
                    ...
                    <tr onMouseOut="this.style.backgroundColor='#ffffff'"
                        ...
                        <td align="left" valign="middle" class="borderright borderbottom main-for">
                            <select name="isCreate" id="level1">
